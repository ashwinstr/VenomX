...
class Collection:
    ...
    # basic collections
    TOGGLES = get_collection("TOGGLES") # DEVELOPER_MODE, FBAN_TAG, F_DEL, GDRIVE, KANGLOG, PM_GUARD, PM_TOG, SUDO, USER_BOT, USER_MODE
    ...
    LAST_MESSAGES_LIST = get_collection("LAST_MESSAGES_LIST")
