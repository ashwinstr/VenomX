...
# https://github.com/thedragonsinn/ub-core/blob/main/ub_core/core/conversation.py
...
async def convo_handler(bot, message: Message):
...
if venom.has_bot:
    ...
    venom.bot.add_handler(
        EditedMessageHandler(callback=convo_handler, filters=convo_filter),
        group=0,
    )
